        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="Login.php">Calculá tu huella de carbono</a>
                    </li>
                ...
                <div><a class="btn btn-danger" id="cerrarSesionCalculadora" href="Login.php" role="button" style="color: rgb(5, 5, 5); margin-left: 3px; border: white;">Cerrar sesión</a></div>
